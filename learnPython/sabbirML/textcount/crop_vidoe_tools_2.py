...
def process_video():
    ...
    source = input("Enter the directory of saved videos: ")
    fps = int(input("Enter the frame per second: "))
    start = input("Enter the start time of the video (Exp: 3.15): ")
    end = input("Enter the end time of the video: ")
